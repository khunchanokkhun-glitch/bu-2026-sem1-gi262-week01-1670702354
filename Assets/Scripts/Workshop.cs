...
public class Workshop : MonoBehaviour
{
    ...
    public void As04_AndOrOperatorExample()
    {
        ...
        {
            Debug.Log("My namber 8 > < 12");
        }
        if (as04Number > 8 ||  as04Number < 12  )
        {
            Debug.Log("My namber or 8 || 12");
        }
    ...
    {
        if (as07Username == "usr" && as07Password == "user123")
        {
            Debug.Log("You have accessd");
            if (as07IsPaid)
            {
                Debug.Log("VIP Number");

            }
            else
            {
                Debug.Log("Feer Nember");

            }
            if (as07Age > 18)
            {
                Debug.Log("You have access to exclusive contene");
            }
        }
        else
        {
            Debug.Log("YOu Ars Uest");
        }
    }
}
